namespace ZetaResourceEditor.UI.Tools
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			panelControl1.Location = new Point(16, 102);
			panelControl1.Margin = new Padding(0);
			panelControl1.Name = "panelControl1";
			tablePanel1.SetRow(panelControl1, 3);
			panelControl1.Size = new Size(293, 157);
			...
			tablePanel2.Size = new Size(289, 153);
			...
			linkLabel1.Location = new Point(16, 110);
			...
			linkLabel1.Properties.Appearance.Font = new Font("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Pixel);
			...
			// labelControl2
			// 
			labelControl2.Appearance.Font = new Font("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Pixel);
			labelControl2.Appearance.Options.UseFont = true;
			tablePanel2.SetColumn(labelControl2, 0);
			labelControl2.Location = new Point(16, 46);
			labelControl2.Margin = new Padding(0, 0, 0, 9);
			labelControl2.Name = "labelControl2";
			tablePanel2.SetRow(labelControl2, 1);
			labelControl2.Size = new Size(166, 51);
			...
			pictureEdit1.Location = new Point(19, 18);
			...
			tablePanel1.SetRowSpan(pictureEdit1, 3);
			pictureEdit1.Size = new Size(78, 81);
			pictureEdit1.TabIndex = 0;
			// 
			// tablePanel1
			// 
			tablePanel1.AutoSize = true;
			tablePanel1.Columns.AddRange(new DevExpress.Utils.Layout.TablePanelColumn[] { new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 31.67F), new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 49.63F), new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 28.7F) });
			...
			tablePanel1.Rows.AddRange(new DevExpress.Utils.Layout.TablePanelRow[] { new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 27.33331F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 51.33308F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 9F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 157.3334F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 9F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 28F) });
			tablePanel1.Size = new Size(325, 315);
			tablePanel1.TabIndex = 0;
			tablePanel1.UseSkinIndents = true;
			// 
			// label4
			// 
			label4.Appearance.Font = new Font("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Pixel);
			...
			label4.Margin = new Padding(0, 0, 0, 9);
			label4.Name = "label4";
			...
			// labelControl3
			// 
			labelControl3.Appearance.Font = new Font("Segoe UI", 13F, FontStyle.Bold, GraphicsUnit.Pixel);
			labelControl3.Appearance.Options.UseFont = true;
			tablePanel1.SetColumn(labelControl3, 1);
			tablePanel1.SetColumnSpan(labelControl3, 2);
			labelControl3.Location = new Point(100, 15);
			...
			buttonClose.Appearance.Font = new Font("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Pixel);
			buttonClose.Appearance.Options.UseFont = true;
			tablePanel1.SetColumn(buttonClose, 2);
			buttonClose.DialogResult = DialogResult.OK;
			buttonClose.Location = new Point(233, 269);
			buttonClose.Margin = new Padding(0);
			buttonClose.Name = "buttonClose";
			tablePanel1.SetRow(buttonClose, 5);
			buttonClose.Size = new Size(76, 28);
			buttonClose.TabIndex = 0;
			buttonClose.Text = "Close";
			buttonClose.WantDrawFocusRectangle = true;
			// 
			// AboutFormModern
			// 
