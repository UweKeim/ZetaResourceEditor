namespace ZetaResourceEditor.UI.Main.RightContent
{
	partial class DeleteRowContentsForm
	{
		...
		private void InitializeComponent()
		{
			...
			deleteCommentsCheckEdit = new ExtendedControlsLibrary.Skinning.CustomCheckEdit.MyCheckEdit();
			...
			((ISupportInitialize)deleteCommentsCheckEdit.Properties).BeginInit();
			...
			selectAllLanguagesToExportButton.TabIndex = 2;
			...
			invertLanguagesToExportButton.TabIndex = 0;
			...
			// 
			tablePanel1.SetColumn(deleteCommentsCheckEdit, 0);
			deleteCommentsCheckEdit.Dock = DockStyle.Left;
			deleteCommentsCheckEdit.Location = new Point(11, 309);
			deleteCommentsCheckEdit.Margin = new Padding(0);
			deleteCommentsCheckEdit.Name = "deleteCommentsCheckEdit";
			deleteCommentsCheckEdit.Properties.Appearance.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
			deleteCommentsCheckEdit.Properties.Appearance.Options.UseFont = true;
			deleteCommentsCheckEdit.Properties.AutoWidth = true;
			deleteCommentsCheckEdit.Properties.Caption = "Also delete comments";
			tablePanel1.SetRow(deleteCommentsCheckEdit, 3);
			deleteCommentsCheckEdit.Size = new Size(152, 28);
			deleteCommentsCheckEdit.TabIndex = 4;
			// 
			...
			selectNoLanguagesToExportButton.TabIndex = 3;
			...
			languagesToDisplayCheckListBox.TabIndex = 1;
			...
			displayAllLanguagesCheckEdit.Properties.Caption = "Delete row contents for all languages";
			...
			displayCertainLanguagesCheckEdit.Properties.Caption = "Delete row contents only for the following languages:";
			...
			tablePanel1.Controls.Add(deleteCommentsCheckEdit);
			...
			Name = "DeleteRowContentsForm";
			ShowInTaskbar = false;
			StartPosition = FormStartPosition.CenterParent;
			Text = "Delete row contents";
			FormClosing += DeleteRowContentsForm_FormClosing;
			Load += DeleteRowContentsForm_Load;
			((ISupportInitialize)deleteCommentsCheckEdit.Properties).EndInit();
