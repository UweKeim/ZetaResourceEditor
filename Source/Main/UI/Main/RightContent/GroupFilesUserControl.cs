namespace ZetaResourceEditor.UI.Main.RightContent
{
		...
		UserControlBase
	{
		...
		/// <summary>
		/// Gets the file group control for tab page.
		/// </summary>
		...
		/// <summary>
		/// Gets the current file group control.
		/// </summary>
		/// <value>The current file group control.</value>
		...
		internal IGridEditableData CurrentFileGroup
		{
			get
			{
				if (CurrentFileGroupControl != null)
				{
					return CurrentFileGroupControl.GridEditableData;
				}
				else
				{
					return null;
		...
		internal IGridEditableData[] GridEditableDatas
		{
			get
			{
