namespace ZetaResourceEditor.UI.Main.LeftTree
{
		...
		UserControlBase
	{
		...
		public bool CanSaveProjectFile
		{
			get
			{
				return Project != null && Project != Project.Empty;
			}
		}
		...
		*/
		...
		public bool CanAddResourceFilesToProject
		{
			...
			{
				return
					Project != null && Project != Project.Empty &&
					treeView.SelectedNode != null &&
					(
		...
		public bool CanSortChildrenAlphabetically
		{
			get
			{
				return
		...
		public bool CanRemoveFileFromFileGroup
		{
			get
			{
				return
					Project != null && Project != Project.Empty &&
						treeView.SelectedNode != null &&
							treeView.SelectedNode.Tag is FileInformation;
			}
		}
		...
		private void updateNodeStateImageBackgroundworker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
		}
		...
		public void RemoveFileFromFileGroupWithDialog()
		{
			...
			if (dr == DialogResult.Yes)
			{
				...
				if (node != null && node.Tag is FileInformation)
				{
		...
		public bool CanConfigureLanguageColumns
		{
			get
			{
				return Project != null && Project != Project.Empty;
		...
		private void removeNodeAndchilds(TreeListNode node)
		{
			if (node != null)
			{
				if (node.Tag is ProjectFolder)
				{
					...
					Project.ProjectFolders.Remove((ProjectFolder)node.Tag);
					Project.MarkAsModified();
