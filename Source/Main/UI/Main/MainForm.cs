	...
	RibbonFormBase
{
	...
	public MainForm()
	{
		...
		if (!DesignModeHelper.IsDesignMode)
		{
			...
			// 
			ProjectFilesControl.Appearance.Font = new("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// groupFilesControl
			// 
			GroupFilesControl.Appearance.Font = new("Segoe UI", 13F, FontStyle.Regular, GraphicsUnit.Point);
	...
	private void updateAvailableBlinkTimer_Tick(object sender, EventArgs e)
	{
		if (buttonUpdateAvailable.Visibility == BarItemVisibility.Always)
		{
			...
			buttonUpdateAvailable.ImageOptions.SvgImage =
				_blinkIndex == 0 
					? ImageCollectionHelper.Update1 
					: ImageCollectionHelper.Update2;
		}
		else
		{
			updateAvailableBlinkTimer.Stop();
