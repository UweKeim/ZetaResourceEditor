namespace ZetaResourceEditor.UI.Helper
{
	...
	{
		/// <summary>
		/// Creates an Image object containing a screen shot of the entire 
		/// desktop.
		/// </summary>
		/// <returns></returns>
		...
		public void CaptureWindowToFile(
			...
			ImageFormat format )
		{
			Image img = CaptureWindow( control.Handle );
		...
		/// <summary>
		/// Captures the screen to clipboard.
		/// </summary>
		...
		/// <summary>
		/// Captures the window to clipboard.
		/// </summary>
		/// <param name="control">The control.</param>
		public void CaptureWindowToClipboard(
			Control control )
		{
			Image img = CaptureWindow( control.Handle );
			Clipboard.SetImage( img );
